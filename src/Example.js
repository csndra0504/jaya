  ...
  onChange = (event, { newValue, method }) => {
    ...
    if (method === 'down' || method === 'up') {
      this.setState({
        ...
        () => {
          console.log('1 KeyPressSelection: ' + method, this.state.isSelectSuggestion);
          console.log('1 NoSuggestion: ' + method, this.state.noSuggestions);
        },
      );
      ...
      this.setState({
        ...
        () => {
          console.log('2 KeyPressSelection: ' + method, this.state.isSelectSuggestion);
          console.log('2 NoSuggestion: ' + method, this.state.noSuggestions);
        },
      );
    }

    // console.log('Input box:');
    console.log('3 KeyPressSelection: ' + method, this.state.isSelectSuggestion);
    console.log('3 NoSuggestion: ' + method, this.state.noSuggestions);
  };
